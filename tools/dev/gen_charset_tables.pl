...
Generate a character set typetable for iso_8859_1.
The previous ascii table here was removed 2010.
...
Create a character table for the first 255 bytes.
The other classes are managed by icu.
